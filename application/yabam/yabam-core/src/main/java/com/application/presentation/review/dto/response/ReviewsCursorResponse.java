...
@Schema(description = "리뷰 커서 응답 DTO", name = "ReviewsCursorResponse")
@Builder
public record ReviewsCursorResponse(
	...
	public static ReviewsCursorResponse from(Slice<Review> reviews) {
		...
		return ReviewsCursorResponse.builder()
