...
public class Table {
	...
	private Table(UUID tableId, Integer tableNumber, Boolean isActive, TablePoint tablePoint, Store store) {
	...
	public static Table of(UUID tableId, Integer tableNumber, Boolean isActive, TablePoint tablePoint, Store store) {
		return new Table(
			tableId,
			tableNumber,
			isActive,
